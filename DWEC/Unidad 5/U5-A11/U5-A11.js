...
var array_colores = document.querySelectorAll('input[type="radio"][name="color"]');

array_colores.forEach((radio) => {

    radio.addEventListener('change', function(){

        if(radio.checked){
            document.getElementById('formulario').style.backgroundColor = radio.value;
        }
